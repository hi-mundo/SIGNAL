...
| **Wall of Understanding** | Common ground, conversational grounding, pragmatic inference, context construction | Grice 1975; Clark and Brennan 1991; [speech act theory](https://en.wikipedia.org/wiki/Speech_act) | SIGNAL is the user-facing understanding layer. The agent loop shown in the README is only an illustrative example, not a recommended architecture or SIGNAL pattern. |
